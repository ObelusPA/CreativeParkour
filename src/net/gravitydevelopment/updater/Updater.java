...
public class Updater {
	...
	// Used to check downloaded file's md5
	...
	private void saveFile(String file) {
		...
		// Check to see if the file has the correct md5
		if (!this.versionMd5.equals(toHex(this.fileMd5)))
		{
			dFile.delete(); // Deleting file to not update
			this.plugin.getLogger().log(Level.WARNING, "The auto-updater tried to download a new update, but the downloaded file is not the expected one.");
		}
		else
		{
